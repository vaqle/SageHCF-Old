...
class DeathbanEntity extends Human {
	...
	public function __construct(Level $level, CompoundTag $nbt) {
		$manager = new IEManager(Sage::getInstance(), "deathban.png");
	...
	public function attack(EntityDamageEvent $event) : void
	{
		if ($event instanceof EntityDamageByEntityEvent) {
			...
			if ($damager instanceof SagePlayer) {
				...
				UtilManager::sendMainForm($damager);
				KitManager::giveKit($damager, "deatban");
	...
	public static function getNPCName(): string{
		$line = [
			...
			str_repeat(" ", 3),
			"\n§r§7Have §r§cLives?\n",
			"§r§7Tap to use a life and assist your faction mates!",
